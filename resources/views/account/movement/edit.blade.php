    ...
    <div class='col-12'>
      ...
      <form action='{!! route('movement.edit-movement', ['accountId'=>$accountId, 'movementId'=>$movement->id]) !!}' method='POST'>
        ...
        <div class='form-group'>
          ...
          <input type='text' name='name' class='form-control' placeholder='Nombre' value="{{$movement->name}}">
          <label for='amount'>Monto del movimiento</label>
          <input type='number' name='amount' class='form-control' placeholder='Monto' value="{{abs($movement->amount)}}">
